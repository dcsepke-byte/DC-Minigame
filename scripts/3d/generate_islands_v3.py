...
ISLANDS = [
    ('01_sonnenstrand',    '#ffe082', '#ffcc80', '#c98a5b', decor_sonnenstrand,    (0.4, 0.6, 0.9, 1.0)),
    ('02_zuckerwald',      '#f8bbd0', '#e1bee7', '#a1887f', decor_zuckerwald,      (0.6, 0.5, 0.75, 1.0)),
    ('03_wolkenwerk',      '#e3f2fd', '#bbdefb', '#90a4ae', decor_wolkenwerk,      (0.5, 0.7, 0.95, 1.0)),
    ('04_frostgipfel',     '#e1f5fe', '#b3e5fc', '#78909c', decor_frostgipfel,     (0.45, 0.55, 0.8, 1.0)),
    ('05_dschungeltempel', '#a5d6a7', '#81c784', '#6d4c41', decor_dschungeltempel, (0.35, 0.55, 0.4, 1.0)),
    ('06_mechanikstadt',   '#cfd8dc', '#b0bec5', '#607d8b', decor_mechanikstadt,   (0.4, 0.45, 0.55, 1.0)),
    ('07_sternenzitadelle','#ffe082', '#ffd54f', '#7b2ff7', decor_sternenzitadelle,(0.25, 0.2, 0.45, 1.0)),
]

if __name__ == '__main__':
    # Erster Durchlauf: alle GLBs exportieren (schnell, spielrelevant)
    import sys
    render_mode = '--render' in sys.argv
    for name, base, ground, rock, fn, wc in ISLANDS:
        try:
            build_island(name, base, ground, rock, fn, wc, do_render=render_mode)
